...
5c. **Welsh audio** (optional) — Analysis tab → **Record new Welsh
...
5d. **Constellation** (optional) — Analysis tab → **Embed new photos**
...
5e. **Shape space** — nothing to run: whenever you Export, the approved
